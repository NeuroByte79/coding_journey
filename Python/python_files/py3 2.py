# Demostrate how to convert from one number to another
...
c = a + b
print(c)
print(int('1011',2))  # convert binary to decimal int
print(int('341',8))  # convert octal to decimal int
print(int('21',16))   # convert from hex to decimal int

# convert to float
print(float(35))   # convert ffrom int to float
